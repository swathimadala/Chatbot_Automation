...
bot = telegram.Bot(token='7174718776:AAFKpaRhYaqz6nYDBpowuipwbe-gcmq1Z8Y') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='7174718776:AAFKpaRhYaqz6nYDBpowuipwbe-gcmq1Z8Y', use_context=True) #Replace TOKEN with your token string
